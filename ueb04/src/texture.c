...
initTextureArray(void)
{
  ...
  g_textures[texDay].filename = "../content/textures/day.tga";
  g_textures[texNight].filename = "../content/textures/night.tga";
  g_textures[texLandscape].filename = "../content/textures/landscape_0.jpg";
